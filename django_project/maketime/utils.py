...
class Calendar(HTMLCalendar):
	...
	def formatmonth(self, withyear=True):
		events = CalEvent.objects.filter(start_time__year=self.year, start_time__month=self.month)
...
class CustomHTMLCalendar(HTMLCalendar):
    ...
    def formatday(self, date_row):
        ...
        if date_row.month != self.month:
            ...
            return '<td class="%s">%d</td>' % (self.cssclasses[date_row.weekday()], date_row.day)
    ...
    def formatyear(self, theyear, width=3):
        ...
        a = v.append
        width = max(width, 1)
        a('<table class="calendar" border="0" cellpadding="0" cellspacing="0" class="year">')
        a('\n')
